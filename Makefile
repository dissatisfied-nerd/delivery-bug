...
docker_up_db:
	docker-compose exec -T db psql "dbname=postgres user=user password=password" <backend/migrations/up.sql

docker_down_db:
	docker-compose exec -T db psql "dbname=postgres user=user password=password" <backend/migrations/down.sql
