...
const (
	...
	insertStoreQuery = `INSERT INTO stores(reputation, name, first_name, surname, last_name, address_id) 
		VALUES($1, $2, $3, $4, $5, $6) RETURNING id`
	...
	selectStoreQuery     = `SELECT reputation, name, first_name, surname, last_name, address_id FROM couriers 
		WHERE id=$1`
